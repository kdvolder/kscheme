  ...
  (if (null? errs) (display "Passed all tests")
      (begin
        ...
        (for-each (lambda (l) (write l) (newline))
                  errs)
        (error "Some tests failed. See console output for details")))
  (newline))
...
; str-copy is useless when strings are immutable
;(define (str-copy s)
;  (string-map (lambda (c) c) s))

(define (string-standard-case s)
  (string-map char-standard-case s))
